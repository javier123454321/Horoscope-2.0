...
const addPerson = person => {
        ...
        //tried changing these to i tags verses spans but there didn't seem to be a difference 
        ...
        trashCan.className = "fas fa-trash-alt delete"
...
function removePerson(event){
    if (event.target.classList.contains("svg-inline--fa fa-trash-alt fa-w-14")){
...
function updateResults(event){
    if (event.target.classList.contains("edit")){
        console.log('did you want to edit me?')
